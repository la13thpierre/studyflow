export default async function handler(req, res) {
    ...
    try {
        ...
        const prompt = `Based on these notes, suggest 4 short, useful questions a student might want to ask a tutor to better understand the material — especially questions that clarify confusing points, compare similar concepts, or fill gaps in understanding. Keep each question under 12 words.
